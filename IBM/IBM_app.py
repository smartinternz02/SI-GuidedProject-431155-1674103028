...
API_KEY = "BZaxgrdi9WREzqlwzeDKYMuueMFU3_2CfbW3EsrqXg6U"
...
def predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/f5b56076-242a-4ed6-9abf-d626100b06de/predictions?version=2023-02-09', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
    ...
    print(output)
    return render_template('upload.html', prediction_text= 'House Rent is Rs {} ',y=output)
